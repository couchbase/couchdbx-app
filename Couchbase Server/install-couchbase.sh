...
if [ -e "$topdir/ns_server/etc/columnar_profile" ]
then
  rm "$dest/etc/couchbase/columnar_profile"
  cp "$topdir/ns_server/etc/columnar_profile"         "$dest/etc/couchbase/columnar_profile"
fi
